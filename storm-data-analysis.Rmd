...
weather event as well as economic damage on properties and crops each weather
event.
...
damage cost estimates were used to determine weather event events with the
...
actual costs of both property and crop damage. Two new variables will be
